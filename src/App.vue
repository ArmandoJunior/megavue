<template>
  <v-app>
    <v-content>
      ...
      <v-row>
        <v-btn :disabled="loading" @click="_raffling()">Iniciar Sorteio</v-btn>
        <v-btn :disabled="loading" @click="_generateRandomGames(3)">Gerar Novos Números</v-btn>
      </v-row>
      <v-divider></v-divider>
